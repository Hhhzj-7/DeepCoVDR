...
from mpn_models_chemprop.features import get_features_generator
...
class MoleculeDatapoint:
    ...
    def __init__(self,
        ...
        self.smiles = line  # str       第一项是smiles
        ...
        # # Create targets
        # self.targets = [float(x) if x != '' else None for x in line[1:]]  # 只计算0，1 空的none
